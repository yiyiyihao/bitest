...
//            ];
            ...
            if ($agelevelList) {
                if($days == 1){
                    $agelevelList = explode(',',$agelevelList);
                    foreach($agelevelList as $k => $v){
                        $where[] = ['age','BETWEEN',[$v*10-10,$v*10]];
                    }
        ...
        foreach ($label as $key => $value) {
            ...
            if($days == 1){
                ...
                $deviceArray = db('face_token')->where($tempWhere)->group('device_id')->column('device_id, count(*)');
