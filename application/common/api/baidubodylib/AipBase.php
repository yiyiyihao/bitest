...
* the License.
*/
namespace app\common\api\baidubodylib;
...
class AipBase {
    ...
    public function __construct(){
        ...
        $this->appId = isset(config('faceRecognition')['appId']) ? config('faceRecognition')['appId'] : '15369697';
        $this->apiKey = isset(config('faceRecognition')['apiKey']) ? config('faceRecognition')['apiKey'] : 't1mROdQWjZbHSVaTSZ68oLDP';
        $this->secretKey = isset(config('faceRecognition')['secretKey']) ? config('faceRecognition')['secretKey'] : 'XU70MCIXM3PqjYj5HGMHuh9bl2B9Zv2q';
